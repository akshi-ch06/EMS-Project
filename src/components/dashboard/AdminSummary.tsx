    ...
    return (
        <div className="p-6">
            ...
            ">
                ...
                <SummaryCard icon={<FaMoneyBill1Wave/>} text='Monthly Salary' number={10000} color="bg-red-600"/>
            </div>
            <div className="mt-12">
                <h4 className="
                text-center
                ...
                ">
                    ...
                    <SummaryCard icon={<FaCheckCircle/>} text='Leave Approved' number={25} color="bg-gray-600"/>
